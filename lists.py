...
def reverse_list_in_place(items):
    ...
    **Do not use** the python function `reversed()` or the method
    ...
    #the i should reflect the number of swaps you're doing

    divided = len(items) // 2
    for i in (range(divided)):
        swap_index = len(items) - i - 1
        #this finds the index of the item closer to the end of the list
        #the index is the length of the list minus 1 
        temp = items[i]
